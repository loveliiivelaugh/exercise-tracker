...
export function useActivity(id) {
  return useQuery(id && firestore.collection("activities").doc(id));
}

// Update an Activity
export function updateActivity(id, data) {
  return firestore.collection("activities").doc(id).update(data);
}
...
export function deleteActivity(id) {
  return firestore.collection("activities").doc(id).delete();
}
